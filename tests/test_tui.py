...
class TestConsoleUI(unittest.TestCase):
    ...
    def test_create_table_success(self):
        self._mock_input(["hotel", "id name room check_in check_out"])
    ...
    def test_add_record_success(self):
        ...
        self.ui._current_table = "hotel"
        self._mock_input(["id", "1", "name", "John", "room", "101", "check_in", "2024-01-01", "check_out", "2024-01-05", ""])
        self.ui._add_record()
        self._restore_input()
    ...
    def test_delete_by_filter_invalid_input(self):
        self.db.create_table("hotel", ["id", "name"])
        self.db.insert_record("hotel", {"id": 1, "name": "John"})
        self.ui._current_table = "hotel"
    ...
    def test_create_table_duplicate_name(self):
        self.db.create_table("hotel", ["id"])
        self._mock_input(["hotel", "id name"])
        self.ui._create_table()
        self._restore_input()
    ...
    def test_show_records_table_not_found(self):
        self.ui._current_table = "ghost"
        self.ui._show_records()
        self.assertIsNone(self.ui._current_table)
    ...
    def test_delete_by_filter_invalid_filter(self):
        self.db.create_table("hotel", ["id", "name"])
        self.ui._current_table = "hotel"
        self._mock_input(["name"])
        self.ui._delete_by_filter()
    ...
    def test_sort_records_no_table_selected(self):
        self.ui._sort_records()
